...
class ExportPekerjaanComplete implements FromView,ShouldAutoSize,WithStyles,WithColumnWidths,WithDrawings, WithEvents
{
    protected $data ;
    protected $project ;
    ...
    {
        return view('export.ExportPekerjaanComplete',['data'=> $this->data,'project' => $this->project]);
    }
