                    ...
                    columns : [
                        ...
                        },
                        {
                            data : function(data){
                                ...
                                return `<div class="">${rupiah(amount)}</div>`;
                            }
                        },
                        {
                            data : function(data){
                                if(data.harga_customer !== null){
                                    ...
                                    return `<div class="">${rupiah(total)}</div>`
                                }else{
