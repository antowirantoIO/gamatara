                ...
                <div class="col-12">
                    <div class="d-flex align-items-center flex-lg-row flex-column">
                        <div class="flex-grow-1 d-flex align-items-center">
                            <h4 class="mb-0 ml-2"> &nbsp; Annual Tonnage Report</h4>
                        </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header border-0 align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Annual Tonnage Report - Replating Category</h4>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="advanceLabel">Filter Annual Tonnage Report</h5>
...
$(document).ready(function() {
    var table = $('#tableData').DataTable({
        ...
        ajax: {
            url: '{{ route("report.summary.annual.tonnage") }}',
            data: function (d) {
...
$('#export-button').on('click', function() {
    ...
    var exportUrl = '{{ route("report.summary.annual.tonnage.export") }}';
