...
class ExportSandblastReport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnWidths
{
    ...
    public function columnWidths(): array
    {
        return [
            ...
            'B' => 20, // NAMA PROJECT
            'C' => 18, // LUASAN SUBCONT (M)
            'D' => 15, // BAGIAN KAPAL
            'E' => 20, // DURASI PROJECT (DAY)
            'F' => 12, // ON PROGRESS
            'G' => 12, // COMPLETE
        ];
    }
