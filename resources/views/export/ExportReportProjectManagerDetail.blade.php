<table>
    <thead>
        <tr>
            <th colspan="4" height="30" align="center"><strong>Report Project Manager Detail -  {{ ucwords($data->first()->pm->karyawan->name ?? '') }}</strong></th>
        </tr>
        <tr>
            <th width="200px" height="30" align="center" style="border: 20px medium black;">No.</th>
    ...
    <tbody>
        @foreach ($data as $key =>  $item)
            <tr>
                <td height="20" style="border: 20px medium black;">{{ $key+1 }}</td>
