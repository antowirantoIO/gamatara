                                    ...
                                    <div class="row gy-4">
                                        <div class="col-xxl-6 col-md-6">
                                            <div>
                                                ...
                                                <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control" placeholder="Enter Employee Name">
                                                @if ($errors->has('name'))
                                        ...
                                        <div class="col-xxl-6 col-md-6">
                                            <div>
                                                ...
                                                <input type="number" name="nomor_telpon" class="form-control" id="nomor_telpon" value="{{ old('nomor_telpon') }}" maxlength="13" placeholder="Enter Phone" oninput="this.value=this.value.slice(0,this.maxLength)">
