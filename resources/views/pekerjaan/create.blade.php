                                    ...
                                    <div class="row gy-4">
                                        <div class="col-xxl-6 col-md-6">
                                            <div>
                                                ...
                                                <input type="text" name="kategori_pekerjaan" class="form-control" id="kategori_pekerjaan" placeholder="Masukkan Kategori Pekerjaan">
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-md-6">
                                            <div>
                                                <label for="sub_kategori_pekerjaan" class="form-label">Sub Kategori Pekerjaan</label>
                                                <input type="text" name="sub_kategori_pekerjaan" class="form-control" id="sub_kategori_pekerjaan" placeholder="Masukkan Sub Kategori Pekerjaan">
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-md-6">
                                            <div>
                                                <label for="jenis_pekerjaan" class="form-label">Jenis Pekerjaan</label>
                                                <input type="text" name="jenis_pekerjaan" class="form-control" id="jenis_pekerjaan" placeholder="Masukkan Jenis Pekerjaan">
                                            </div>
                                        </div>
                                        <div class="col-xxl-6 col-md-6">
                                            <div>
                                                <label for="detailother" class="form-label">Detail / Other</label>
                                                <input type="text" name="detailother" class="form-control" id="detailother" placeholder="Masukkan Detail / Other">
                                            </div>
                                        </div>      
                                        <div class="col-xxl-6 col-md-6">
                                            <div>
                                        ...
                                        <div class="col-xxl-6 col-md-6">
                                            <div>
                                                ...
                                                <input type="text" name="harga_vendor" class="form-control" id="harga_vendor" placeholder="Rp.000.000">
                                            </div>
                                        </div>  
                                        <div class="col-xxl-6 col-md-6">
                                            <div>
                                                <label for="harga_customer" class="form-label">Harga Customer</label>
                                                <input type="text" name="harga_customer" class="form-control" id="harga_customer" placeholder="Rp.000.000">
                                            </div>
                                        </div>  
                                        <div class="col-xxl-6 col-md-6">
                                            <div>
                                                <label for="convert" class="form-label">Convert</label>
                                                <input type="text" name="convert" class="form-control" id="convert" placeholder="100/100">
                                            </div>
                                        </div>  
