                ...
                <div class="col-12">
                    <div class="d-flex align-items-center flex-lg-row flex-column">
                        <div class="flex-grow-1 d-flex align-items-center">
                            <h4 class="mb-0 ml-2"> &nbsp; Replating Report</h4>
                        </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header border-0 align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Work Type Report - Replating</h4>
                        </div>
                                ...
                                <table class="table table-bordered" id="tableData">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th style="color:#929EAE; text-align: center;">TONASE (KG)</th>
...
<div id="advance" class="modal fade zoomIn" tabindex="-1" aria-labelledby="zoomInModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="formReplating" method="get" enctype="multipart/form-data">
            @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="zoomInModalLabel">Filter Replating Report</h5>
...
$(document).ready(function () {
    ...
    var table = $('#tableData').DataTable({
        ...
        ajax: {
            url: '{{ route("report.work_type.replating") }}',
            data: function (d) {
        ...
        columns: [
            ...
            { data: 'tonase_kg', name: 'tonase_kg', className: 'text-center' },
...
// Export Excel functionality
        $('#export-button').on('click', function() {
            var subcontractorFilter = $('#subcontractor').val();
            var projectFilter = $('#project').val();
    
    var exportUrl = '{{ route("report.work_type.replating.export") }}';
